...
function loadESXPlayer(identifier, playerId, isNew)
	...
	local xPlayer = CreateExtendedPlayer(playerId, identifier, userData.group, userData.accounts, userData.inventory, userData.weight, userData.job, userData.job2, userData.job3, userData.loadout, userData.playerName, userData.coords, userData.metadata)
